...
var stateOperationButtonArray = [
    {id: 102, name: "下单", url: "offer/orderOffer"}, {
...
class ListTable extends React.Component  {
    ...
    constructor(props) {
        ...
        this.thcols = [{dataField: "commodityName", dataName: "品名"}, {
            dataField: "offerNum",
            dataName: "总吨数（湿吨）",
            width: 120
        ...
        this.row2 = [{dataField: 'commodityName'}, {
            dataField: 'offerNum',
...
function customFormatterOperation(cell, row) {
    ...
    var result = "<button target='_blank' class='btn btn-ghost btn-primary btn-xs' onclick=winOpen(getStatusOperationButtonUrl(99).url," + JSON.stringify(obj) + ")>详情</button>";
    // 自己公司的卖盘不能下单
    if (row.customerId == $("#_customerId").val()) {
        return result;
    }
