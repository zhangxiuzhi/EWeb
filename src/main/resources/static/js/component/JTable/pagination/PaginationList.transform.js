...
var PaginationList = function (_React$Component) {
  ...
  _createClass(PaginationList, [{
    ...
    value: function render() {
      ...
      return React.createElement('div', { className: 'row orderTable-pagination' }, content || React.createElement('div', null, React.createElement('div', { className: 'col-md-6 col-xs-6 col-sm-6 col-lg-6' }, total, sizePerPageList.length > 1 ? dropdown : null), React.createElement('div', { className: 'col-md-6 col-xs-6 col-sm-6 col-lg-6' }, pageBtns)));
    }
  }, {
    key: 'makeDropDown',
