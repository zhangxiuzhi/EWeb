...
export default class PaginationList extends React.Component {
  ...
  render() {
    ...
    const offset = Math.abs(CONST_VAR.PAGE_START_INDEX - pageStartIndex);
    ...
    return (
      <div className='row orderTable-pagination'>
        {
          content ||
          <div>
  ...
  makePage(isCustomPagingPanel = false) {
    ...
    //  'pagination'
    //);
    const classname = "react-bootstrap-table-page-btns-ul pagination";
    return (
